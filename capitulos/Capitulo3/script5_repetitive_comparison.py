...
plt.savefig('rep_gain_variation.png', dpi=1000)
plt.tight_layout()
...
plt.xlabel("Frequency (Hz)")
plt.ylabel("Phase (deg)")
FTMA1 = pandas.read_csv("D:/Users/FELIPE/Documents/Mestrado/dissertacao/capitulos/Capitulo3/FTMA1.csv")
mag_plot.plot(FTMA1["w"]*0.15915494, 20*np.log10(FTMA1["g1"]), label='Without filter', c='blue', lineWidth=1)
phase_plot.plot(FTMA1["w"]*0.15915494, FTMA1["f1"], c='blue', lineWidth=1)
legend = mag_plot.legend(loc='best', shadow=True, fontsize='9')
...
mag_plot.grid(True, which='minor', axis='both')
plt.savefig('rep_with_filter.png', dpi=1000)
plt.tight_layout()
...
mag_plot.plot(FTMA["w"]*0.15915494, 20*np.log10(FTMA["g1"]), label='With low-pass filter', c='blue', lineWidth=1)
...
phase_plot.set(xlim=[100*0.15915494, 100000*0.15915494], ylim=[-270, 45])
mag_plot.grid(True, which='minor', axis='both')
plt.savefig('rep_without_filter.png', dpi=1000)
plt.tight_layout()
